    ...
    mediaFactory(data) {
        ...
        function getMediaUserDOM(){
            ...
            if(picture.slice(-('undefined').length).match('undefined') ){
                ...
                <video controls src="${videoMp4}" class="img-gallery" name="${video}"  onclick="displayLightbox()">Ici la description alternative</video>
        ...
        function getLightboxPhotoDOM(){
            ...
            <img src="assets/icons/chevron-left.svg" onclick="previousSlide()" class="chevron-left" alt="chevron photo précédente" tabindex="2"/>
            <img src="assets/icons/chevron-right.svg" onclick="nextSlide()" class="chevron-right" alt="Chevron Slide suivante" tabindex="3"/>
            </header>
        ...
        function getLightboxVideoDOM(){
            ...
            <header>
            <img src="assets/icons/close-lightbox.svg" onclick="closeLightbox()"   class="cross"alt="Croix ferme modal" tabindex="1"/>
            <img src="assets/icons/chevron-left.svg" onclick="previousSlide()" class="chevron-left" alt="chevron Slide précédente" tabindex="2"/>
            <img src="assets/icons/chevron-right.svg" onclick="nextSlide()" class="chevron-right" alt="Chevron Slide suivante" tabindex="3"/>
            </header>
            <div class="image-contain">
